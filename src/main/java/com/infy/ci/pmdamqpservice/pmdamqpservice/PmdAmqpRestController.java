package com.infy.ci.pmdamqpservice.pmdamqpservice;
...
@Component
@Configuration
@RequestMapping("/pmddata")
public class PmdAmqpRestController {
	...
	private final Logger logger = LoggerFactory.getLogger(PmdAmqpRestController.class);
	

	@RequestMapping(value = "/{projectid}/pm/aggregate", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/pm/modulewise", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/pm/week", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/pm/month", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/pm/custom", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/pm/{buildnumber}", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
